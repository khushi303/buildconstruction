            ...
            <div className='container xl:max-w-[1320px] mx-auto lg:px-4 px-6'>
                <div className='flex flex-row flex-wrap lg:justify-between lg:gap-0 md:gap-7 sm:gap-5 gap-6 justify-center'>
                    {Carddata.map((a) => {
                        return (
                            <>
                                <div data-aos="zoom-in" className='lg:w-[31.73%] sm:w-[48%]'>
                                    <div className='pl-[15px] pr-[14px] pt-[15px] pb-[26px] rounded-[5px] hover:translate-y-[-8px] transition-transform duration-300 ease-linear cursor-pointer bg-white'>
