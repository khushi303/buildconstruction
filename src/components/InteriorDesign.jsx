                    ...
                    <div data-aos="fade-left" className='lg:w-5/12 w-full flex justify-end items-end'>
                        <div className='lg:max-w-[374px]'>
                            ...
                            <div className='flex justify-end'>
                                <button className=''><a href="" className='flex items-center lg:justify-end gap-1 xl:mt-[29px] lg:mt-[14px] sm:mt-[25px] mt-[20px]'><span className='text-[16px] font-bold text-[#025066] leading-[120.187%]'>VIEW PROJECTS </span><Serviceplaybtn /></a></button>
                            </div>
                        </div>
                    </div>
                </div>
